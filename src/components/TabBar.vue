<template>
  <div>
    <div class="tabs">
      <!-- TAB 1 -->
      <input type="radio" name="tab" id="tab-01" :checked="active === '/'" @click='goTo("/")'/>
      <label for="tab-01">
        <svg>
      ...
      <!-- TAB 2 -->
      <input type="radio" name="tab" id="tab-02" :checked="active === '/gameIndex'" @click='goTo("/gameIndex")'/>
      <label for="tab-02">
        <svg>
      ...
      <!-- TAB 3 -->
      <input type="radio" name="tab" id="tab-03" :checked="active === '/wiki'" @click='goTo("/chat")'/>
      <label for="tab-03">
        <svg>
      ...
      <!-- TAB 4 -->
      <input type="radio" name="tab" id="tab-04" :checked="active === '/mine'" @click='goTo("/mine")'/>
      <label for="tab-04">
        <svg>
